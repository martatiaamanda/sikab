<nav class="navbar navbar-main  px-0 mx-4 shadow-none border-radius-xl bg-gradient-faded-info my-3" id="navbarBlur"
    navbar-scroll="true">
    ...
    <div class="container-fluid py-1 px-3 d-flex justify-content-between">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5  text-white">
                <li class="breadcrumb-item text-sm"><a class=" text-white" href="{{ route('user.buat-surat') }}">Pages</a>
                </li>
