                ...
                <div class="card card-plain mt-8">
                  ...
                  <div class="card-body">
                    <form role="form" method="POST" action="{{ route('login') }}">
                      ...
                      @error('email')
                      <p class="text-danger text-center p-0 m-0">Kombinasi Email / NIK dan Password salah</p>
                    @enderror

                      <div class="text-center">
                        <button type="submit" class="btn bg-gradient-faded-info w-100 mt-4 mb-0 text-white">Login</button>
                      </div>
                    </form>
                  </div>
                  <div class="card-footer text-center pt-0 px-lg-2 px-1">
                    <p class="mb-4 text-sm mx-auto">
                      Belum memiliki akun ?
                      <a href="{{ route('register') }}" class="text-info text-gradient font-weight-bold">Dafatat di sini </a>
                    </p>
                  </div>
                </div>
              </div>
