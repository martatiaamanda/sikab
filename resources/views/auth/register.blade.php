                        ...
                        <div class="card card-plain mt-8">
                                ...
                                <form role="form" method="POST" action="{{ route('register.store') }}">
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input name="name" id="name" type="text" class="form-control" placeholder="Nama Lengkap" aria-label="name" aria-describedby="name-addon" value="{{ old('name') }}">
                                            @error('name')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input name="alamat" id="alamat" type="text" class="form-control" placeholder="Alamat Lengkap" aria-label="alamat" value="{{ old('alamat') }}">
                                            @error('alamat')
                                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input name="tempat_lahir" id="tempat_lahir" type="text" class="form-control" placeholder="Tempat Lahir" aria-label="tempat_lahir" value="{{ old('tempat_lahir') }}">
                                            @error('tempat_lahir')
                                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input name="tanggal_lahir" id="tanggal_lahir" type="date" class="form-control" placeholder="Tanggal Lahir" aria-label="tanggal_lahir" value="{{ old('tanggal_lahir') }}">
                                            @error('tanggal_lahir')
                                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input name="no_hp" id="no_hp" type="text" class="form-control" placeholder="Nomor Handphone" aria-label="no_hp" value="{{ old('no_hp') }}">
                                            @error('no_hp')
                                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                                            @enderror
                                        </div>
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-4 text-sm mx-auto">
                                    Sudah memiliki akun ?
                                    <a href="{{ route('login') }}" class="text-info text-gradient font-weight-bold">login di sini </a>
                                </p>
                            </div>
                        </div>
                    </div>
