        ...
        <div class="row">
            <div class="col-xl-11 col-lg-11 col-md-11 d-flex flex-column">
                <div class="card ">
                    <div class="card-body">
                        <form role="form" ">
                            ...
                            <div class="card-header pb-3 text-left bg-transparent">
                                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 text-danger">catatan</h6>
                                <p class="ms-2 mb-0 pb-1">" <strong>Nomor Awal</strong> " pada kolom yang harus disi
                            adalah nomor sebelum
                            urutan surat, dan </p>
                            <p class="ms-2 mb-2">" <strong>Nomor Akhir</strong> " surat terletak pada nomor
                                setelah urutan surat. </p>
                    </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-7 mb-3">
                            ...
                            <input name="name" id="name" type="text" class="form-control"
                                ...
                                value="{{ $nomor_surat->awal }}" disabled>
                        </div>
                        <div class="col-md-7 mb-3">
                            <label for="NIP">Nomor Akhir</label>
                            <input name="NIP" id="NIP" type="text" class="form-control" placeholder="NIP"
                                aria-label="NIP" value="{{ $nomor_surat->akhir }}" disabled>
                        </div>
                        <div class="col-md-7 mb-3">
                            <label for="NIP">Tahun</label>
                            <input name="NIP" id="NIP" type="text" class="form-control" placeholder="NIP"
                                aria-label="NIP" value="{{ $nomor_surat->tahun }}" disabled>
                        </div>
                    ...
                    <div class="text-end">
                        <button type="button" class="btn bg-gradient-faded-info mt-4 mb-0 text-white"
                            ...
                            <div class="row mb-5">
                                <div class=" mb-3">
                                    ...
                                    <input name="awal" id="awal" type="text" class="form-control"
                                        placeholder="Nama Lengkap" aria-label="awal" aria-describedby="awal-addon"
                                        value="{{ $nomor_surat->awal }}">
                                    @error('awal')
                                ...
                                <div class=" mb-3">
                                    ...
                                    <input type="number" class="form-control" id="tahun" name="tahun"
                                        ...
                                        value="{{ $nomor_surat->tahun }}" required>
                                    @error('tahun')
                                        <p class="text-danger p-0 m-0">{{ $message }}</p>
                                    @enderror
                                </div>
