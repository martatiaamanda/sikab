                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="form-group">
                            <input type="text" class="form-control" id="nama_ibu" name="nama_ibu"
                                placeholder="Nama Lengkap" value="{{ $bansos->data_bansos->nama_ibu }}">
                            @error('nama_ibu')
                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="form-group">
                            <input type="number" class="form-control" id="umur_ibu" name="umur_ibu"
                                placeholder="Umur" value="{{ $bansos->data_bansos->umur_ibu }}">
                            @error('umur_ibu')
                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="form-group">
                            <input type="text" class="form-control" id="pekerjaan_ibu" name="pekerjaan_ibu"
                                placeholder="pekerjaan" value="{{ $bansos->data_bansos->pekerjaan_ibu }}">
                            @error('pekerjaan_ibu')
                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="form-group">
                            <textarea class="form-control" name="alamat_ibu" id="alamat_ibu" aria-label="With textarea"
                                placeholder="ALmat Lengkap">{{ $bansos->data_bansos->alamat_ibu }}</textarea>
                            @error('alamat_ibu')
                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="form-group">
                            <input type="text" class="form-control" id="nama_ayah" name="nama_ayah"
                                placeholder="Nama Lengkap" value="{{ $bansos->data_bansos->nama_ayah }}">
                            @error('nama_ayah')
                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="form-group">
                            <input type="number" class="form-control" id="umur_ayah" name="umur_ayah"
                                placeholder="Umur" value="{{ $bansos->data_bansos->umur_ayah }}">
                            @error('umur_ayah')
                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="form-group">
                            <input type="text" class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah"
                                placeholder="Pekerjaan" value="{{ $bansos->data_bansos->pekerjaan_ayah }}">
                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="form-group">
                            <textarea class="form-control" name="alamat_ayah" id="alamat_ayah" aria-label="With textarea"
                                placeholder="ALmat Lengkap">{{ $bansos->data_bansos->alamat_ayah }}</textarea>
                            @error('alamat_ayah')
                                <p class="text-danger p-0 m-0">{{ $message }}</p>
                            @enderror
                        </div>
